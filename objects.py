...
class CustomFlask(Flask):
    ...
    def initialize_modules(self):
        ...
        """
        main_mod_1 = MasterModule(title = "What Is a Data Center?", label = "1", objective = "In the first module, we’ll cover the basics of what a data center is. We’ll start with the basic information you need to understand this topic. This includes what data centers look like, how they work, and who stands to profit from them. Let’s get started!")
        main_mod_2 = MasterModule(title = "What Are the Broad Implications?", label = "2", objective = "In the second module, we’re going to take a look at how data centers use resources such as energy, water, RAM, and certain rare metals. We’ll discuss why these things are necessary for keeping a data center running, and look at the scale of usage of these resources.")
        main_mod_3 = MasterModule(title = "What Are the Local Effects?", label = "3", objective = "In the third module, we’re going to zoom in and take a look at the impacts that data centers have on the communities where they exist. This means looking at prices of electricity, gas, and water in communities with data centers nearby. It also means looking at the environmental impacts and even health hazards that are associated with data centers.")
        main_mod_4 = MasterModule(title = "How Are You Affected and What Can You Do?", label = "4", objective = "In our final module, we want to tell you a bit about what the present and future of data center operations look like. Where are they, and where will new ones be in a few years? We also want to leave you with some resources so that you know what you can do to stay informed and make your voice heard.")
